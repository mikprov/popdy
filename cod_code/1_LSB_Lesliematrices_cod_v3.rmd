...
for (i in 1:length(names(Alist))) {
  ...
  write.table(Alist[[i]],
              file=paste("C:/Users/provo/Documents/GitHub/popdy/cod_code/mikaelaLeslie/k1_basematrix_maxages/",
                         codNames[i],".txt",sep=""))
...
for (i in 1:length(LSBlist)) { # step through each pop in datalist
  ...
  for (u in 1:length(ks)) {
    lsb.at.k[,u] = calculate_LSB_at_age_by_F(data=datalist[[i]], littlek=ks[u], maxage=maxage,
  ...
  #            file=paste("C:/Users/provo/Documents/GitHub/popdy/cod_code/mikaelaLSB/LSBmatrix_maxages/",
   #                      codNames[i],".txt",sep=""))
   write.table(LSBlist[[i]],
              file=paste("C:/Users/provo/Documents/GitHub/popdy/cod_code/mikaelaLSB/LSB_k_matrix/",
                         codNames[i],".txt",sep=""))
  rm(K,L_inf,maxage,TEMP,B0,B1)
}
